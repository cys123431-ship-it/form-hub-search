...
export const municipalRegionProfiles = [
  ...
  { canonical: "경기도", aliases: ["경기", "경기도"], districts: [], officialDomains: ["gg.go.kr", "suwon.go.kr", "seongnam.go.kr", "goyang.go.kr", "yongin.go.kr", "bucheon.go.kr", "ansan.go.kr"] },
  { canonical: "강원특별자치도", aliases: ["강원", "강원도", "강원특별자치도"], districts: [], officialDomains: ["provin.gangwon.kr", "chuncheon.go.kr", "wonju.go.kr"] },
  { canonical: "충청북도", aliases: ["충북", "충청북도"], districts: [], officialDomains: ["chungbuk.go.kr", "cheongju.go.kr"] },
  { canonical: "충청남도", aliases: ["충남", "충청남도"], districts: [], officialDomains: ["cn.go.kr", "cheonan.go.kr", "asan.go.kr"] },
  { canonical: "전북특별자치도", aliases: ["전북", "전라북도", "전북특별자치도"], districts: [], officialDomains: ["jeonbuk.go.kr", "jeonju.go.kr", "gunsan.go.kr", "iksan.go.kr"] },
  { canonical: "전라남도", aliases: ["전남", "전라남도"], districts: [], officialDomains: ["jeonnam.go.kr", "mokpo.go.kr", "suncheon.go.kr"] },
  { canonical: "경상북도", aliases: ["경북", "경상북도"], districts: [], officialDomains: ["gb.go.kr", "pohang.go.kr", "andong.go.kr"] },
  { canonical: "경상남도", aliases: ["경남", "경상남도"], districts: [], officialDomains: ["gyeongnam.go.kr", "changwon.go.kr", "gimhae.go.kr", "jinju.go.kr"] },
  { canonical: "제주특별자치도", aliases: ["제주", "제주도", "제주특별자치도"], districts: [], officialDomains: ["jeju.go.kr", "jejusi.go.kr", "seogwipo.go.kr"] },
];
